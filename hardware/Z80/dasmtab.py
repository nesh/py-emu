...
MNEMONICS_ED = (
  ...
  "!NEG","!RETN","!IM 1","DB EDh,77h",
  "IN A,(C)","OUT (C),A","ADC HL,SP","LD SP,(#)",
  "!NEG","!RETN","!IM 2","DB EDh,7Fh",
...
MNEMONICS_XX = (
  ...
  "JR NZ,@","LD I%,#","LD (#),I%","INC I%","INC I%h","DEC I%h","LD I%h,*","DAA",
  ...
  "LD A,B","LD A,C","LD A,D","LD A,E","LD A,I%h","LD A,I%l","LD A,(I%^)","LD A,A",
...
MNEMONICS_XCB = (
  "RLC (I%@),B","RLC (I%@),C","RLC (I%@),D","RLC (I%@),E","RLC (I%@),H","RLC (I%@),L","RLC (I%@)","RLC (I%@),A",
  "RRC (I%@),B","RRC (I%@),C","RRC (I%@),D","RRC (I%@),E","RRC (I%@),H","RRC (I%@),L","RRC (I%@)","RRC (I%@),A",
  "RL (I%@),B","RL (I%@),C","RL (I%@),D","RL (I%@),E","RL (I%@),H","RL (I%@),L","RL (I%@)","RL (I%@),A",
  "RR (I%@),B","RR (I%@),C","RR (I%@),D","RR (I%@),E","RR (I%@),H","RR (I%@),L","RR (I%@)","RR (I%@),A",
  "SLA (I%@),B","SLA (I%@),C","SLA (I%@),D","SLA (I%@),E","SLA (I%@),H","SLA (I%@),L","SLA (I%@)","SLA (I%@),A",
  "SRA (I%@),B","SRA (I%@),C","SRA (I%@),D","SRA (I%@),E","SRA (I%@),H","SRA (I%@),L","SRA (I%@)","SRA (I%@),A",
  "SLL (I%@),B","SLL (I%@),C","SLL (I%@),D","SLL (I%@),E","SLL (I%@),H","SLL (I%@),L","SLL (I%@)","SLL (I%@),A",
  "SRL (I%@),B","SRL (I%@),C","SRL (I%@),D","SRL (I%@),E","SRL (I%@),H","SRL (I%@),L","SRL (I%@)","SRL (I%@),A",
  "BIT 0,(I%@)","BIT 0,(I%@)","BIT 0,(I%@)","BIT 0,(I%@)","BIT 0,(I%@)","BIT 0,(I%@)","BIT 0,(I%@)","BIT 0,(I%@)",
  "BIT 1,(I%@)","BIT 1,(I%@)","BIT 1,D","BIT 1,(I%@)","BIT 1,(I%@)","BIT 1,(I%@)","BIT 1,(I%@)","BIT 1,(I%@)",
  "BIT 2,(I%@)","BIT 2,(I%@)","BIT 2,D","BIT 2,(I%@)","BIT 2,(I%@)","BIT 2,(I%@)","BIT 2,(I%@)","BIT 2,(I%@)",
  "BIT 3,(I%@)","BIT 3,(I%@)","BIT 3,D","BIT 3,(I%@)","BIT 3,(I%@)","BIT 3,(I%@)","BIT 3,(I%@)","BIT 3,(I%@)",
  "BIT 4,(I%@)","BIT 4,(I%@)","BIT 4,D","BIT 4,(I%@)","BIT 4,(I%@)","BIT 4,(I%@)","BIT 4,(I%@)","BIT 4,(I%@)",
  "BIT 5,(I%@)","BIT 5,(I%@)","BIT 5,D","BIT 5,(I%@)","BIT 5,(I%@)","BIT 5,(I%@)","BIT 5,(I%@)","BIT 5,(I%@)",
  "BIT 6,(I%@)","BIT 6,(I%@)","BIT 6,D","BIT 6,(I%@)","BIT 6,(I%@)","BIT 6,(I%@)","BIT 6,(I%@)","BIT 6,(I%@)",
  "BIT 7,(I%@)","BIT 7,(I%@)","BIT 7,D","BIT 7,(I%@)","BIT 7,(I%@)","BIT 7,(I%@)","BIT 7,(I%@)","BIT 7,(I%@)",
  "RES 0,(I%@),B","RES 0,(I%@),C","RES 0,(I%@),D","RES 0,(I%@),E","RES 0,(I%@),H","RES 0,(I%@),L","RES 0,(I%@)","RES 0,(I%@),A",
  "RES 1,(I%@),B","RES 1,(I%@),C","RES 1,(I%@),D","RES 1,(I%@),E","RES 1,(I%@),H","RES 1,(I%@),L","RES 1,(I%@)","RES 1,(I%@),A",
  "RES 2,(I%@),B","RES 2,(I%@),C","RES 2,(I%@),D","RES 2,(I%@),E","RES 2,(I%@),H","RES 2,(I%@),L","RES 2,(I%@)","RES 2,(I%@),A",
  "RES 3,(I%@),B","RES 3,(I%@),C","RES 3,(I%@),D","RES 3,(I%@),E","RES 3,(I%@),H","RES 3,(I%@),L","RES 3,(I%@)","RES 3,(I%@),A",
  "RES 4,(I%@),B","RES 4,(I%@),C","RES 4,(I%@),D","RES 4,(I%@),E","RES 4,(I%@),H","RES 4,(I%@),L","RES 4,(I%@)","RES 4,(I%@),A",
  "RES 5,(I%@),B","RES 5,(I%@),C","RES 5,(I%@),D","RES 5,(I%@),E","RES 5,(I%@),H","RES 5,(I%@),L","RES 5,(I%@)","RES 5,(I%@),A",
  "RES 6,(I%@),B","RES 6,(I%@),C","RES 6,(I%@),D","RES 6,(I%@),E","RES 6,(I%@),H","RES 6,(I%@),L","RES 6,(I%@)","RES 6,(I%@),A",
  "RES 7,(I%@),B","RES 7,(I%@),C","RES 7,(I%@),D","RES 7,(I%@),E","RES 7,(I%@),H","RES 7,(I%@),L","RES 7,(I%@)","RES 7,(I%@),A",
  "SET 0,(I%@),B","SET 0,(I%@),C","SET 0,(I%@),D","SET 0,(I%@),E","SET 0,(I%@),H","SET 0,(I%@),L","SET 0,(I%@)","SET 0,(I%@),A",
  "SET 1,(I%@),B","SET 1,(I%@),C","SET 1,(I%@),D","SET 1,(I%@),E","SET 1,(I%@),H","SET 1,(I%@),L","SET 1,(I%@)","SET 1,(I%@),A",
  "SET 2,(I%@),B","SET 2,(I%@),C","SET 2,(I%@),D","SET 2,(I%@),E","SET 2,(I%@),H","SET 2,(I%@),L","SET 2,(I%@)","SET 2,(I%@),A",
  "SET 3,(I%@),B","SET 3,(I%@),C","SET 3,(I%@),D","SET 3,(I%@),E","SET 3,(I%@),H","SET 3,(I%@),L","SET 3,(I%@)","SET 3,(I%@),A",
  "SET 4,(I%@),B","SET 4,(I%@),C","SET 4,(I%@),D","SET 4,(I%@),E","SET 4,(I%@),H","SET 4,(I%@),L","SET 4,(I%@)","SET 4,(I%@),A",
  "SET 5,(I%@),B","SET 5,(I%@),C","SET 5,(I%@),D","SET 5,(I%@),E","SET 5,(I%@),H","SET 5,(I%@),L","SET 5,(I%@)","SET 5,(I%@),A",
  "SET 6,(I%@),B","SET 6,(I%@),C","SET 6,(I%@),D","SET 6,(I%@),E","SET 6,(I%@),H","SET 6,(I%@),L","SET 6,(I%@)","SET 6,(I%@),A",
  "SET 7,(I%@),B","SET 7,(I%@),C","SET 7,(I%@),D","SET 7,(I%@),E","SET 7,(I%@),H","SET 7,(I%@),L","SET 7,(I%@)","SET 7,(I%@),A"
)