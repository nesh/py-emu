...
def _init_tables():
    ...
    SZXYP_TABLE = tuple(SZXYP_TABLE)
    PARITY_TABLE = tuple(PARITY_TABLE)
...
# operations
HC_ADD_TABLE = (0, HF, HF, HF, 0, 0, 0, HF)
HC_SUB_TABLE = (0, 0, HF, 0, HF, 0, HF, HF)

# Similarly, overflow can be determined by looking at the 7th bits; again
# the hash into this table is r12
OV_ADD_TABLE = (0, 0, 0, VF, VF, 0, 0, 0)
OV_SUB_TABLE = (0, VF, 0, 0, 0, 0, VF, 0)
